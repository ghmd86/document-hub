@echo off
echo ========================================
echo TEST: Conditional Matching - PLATINUM
echo ========================================
echo Account: aaaa0000-0000-0000-0000-000000000001
echo Credit Limit: $75,000 (>= $50,000)
...
curl -X POST "http://localhost:8080/api/v1/documents-enquiry" ^
  ...
  -H "X-version: 1" ^
  -H "X-correlation-id: test-platinum-001" ^
