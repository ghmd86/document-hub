...
import io.swagger.model.MetadataNode;
 ...
 */
@Schema(description = "Each document type has its own set of required metadata so it can be properly indexed. Required fields and expected format can be retrieved using GET /templates.")
@Validated
@NotUndefined
...
public class Metadata extends ArrayList<MetadataNode>  {
